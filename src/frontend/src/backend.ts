...
export class Backend implements backendInterface {
    ...
    async countSessions(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.countSessions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveSession(arg0: SessionId, arg1: string, arg2: GenerationSettings, arg3: Array<Variant>): Promise<SessionId> {
        if (this.processError) {
            try {
